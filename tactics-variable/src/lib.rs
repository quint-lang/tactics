...
///
/// ```
/// # use tactics_variable as tactics;
/// use ndarray;
///
/// let a = ndarray::array![[1., 2.], [3.,4.]];
/// let t = tactics::from_ndarray(a.clone());
///
/// assert_eq!(*t.data(), a);
/// ```
...
/// # use tactics_variable as tactics;
///
/// let t1 = tactics::zeros(1);
/// let t2 = tactics::zeros((1, 5));
/// let t3 = tactics::zeros([1, 2, 3]);
///
...
/// # use tactics_variable as tactics;
///
/// let t1 = tactics::ones(1);
/// let t2 = tactics::ones((1, 5));
/// let t3 = tactics::ones([1, 2, 3]);
///
/// assert_eq!(t1.data().shape(), &[1]);
/// assert_eq!(t2.data().shape(), &[1, 5]);
/// assert_eq!(t3.data().shape(), &[1, 2, 3]);
...
/// # use tactics_variable as tactics;
///
/// let t1 = tactics::full(1, 5.); // Filled with 5.0
/// let t2 = tactics::full((1, 5), 6.); // Filled with 6.0
/// let t3 = tactics::full([1, 2, 3], 8.); // Filled with 8.0
///
/// assert_eq!(t1.data().shape(), &[1]);
/// assert_eq!(t2.data().shape(), &[1, 5]);
/// assert_eq!(t3.data().shape(), &[1, 2, 3]);
...
/// use ndarray::arr1;
///
/// let tensor = tactics::linspace(0., 1., 5);
...
/// use ndarray::arr1;
///
/// let tensor = tactics::range(0., 5., 1.);
